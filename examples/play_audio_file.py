"""Transfer a PCM WAV file from the computer and play it on the robot."""
...
def main() -> None:
    ...
    print(f"Transferring and playing / 即将传输并播放：{SAMPLE_AUDIO.resolve()}")
    ...
    print("Robot playback completed / 设备端播放完成。")
