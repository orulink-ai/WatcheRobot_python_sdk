...
const ENGLISH_PHRASES = new Map([
  ...
  ["从运动、灯光到相机，所有测试均由当前 Python Application 调用公开 SDK API，", "From motion and lighting to camera, every test uses public SDK APIs from the current Python Application"],
  ...
  ["Python Application 不转发媒体帧。", "The Python Application does not relay media frames."],
