...
class WatcheRobot:
    def __init__(
        ...
        transport: Any,
        *,
        opus_decoder_factory: Callable[[], Any] = OpusDecoder,
    ) -> None:
        self._transport = transport
        self._opus_decoder_factory = opus_decoder_factory
    ...
    def _from_transport(
        ...
        *,
        ...
        return cls(transport, opus_decoder_factory=opus_decoder_factory)
