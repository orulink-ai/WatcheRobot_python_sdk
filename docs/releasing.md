...
```powershell
gh release create v0.1.0a5 --target main --draft --prerelease --generate-notes
```

4. 核对 Release 内容后发布：

```powershell
gh release edit v0.1.0a5 --draft=false
```
...
.venv-pypi-test\Scripts\python -m pip install watcherobot==0.1.0a5
.venv-pypi-test\Scripts\python -c "import watcherobot; print(watcherobot.__version__)"
```

## 版本规则

- Alpha：`0.1.0a1`、`0.1.0a2`、`0.1.0a3`、`0.1.0a4`、`0.1.0a5`
- Beta：`0.1.0b1`
